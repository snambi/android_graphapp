...
public class ServiceListActivity extends FragmentActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
    	...
    	Fragment listFragment = new ServiceListFragment();
    	transaction.add(R.id.service_detail_container, listFragment);
    	transaction.commit();
        ...
        if (findViewById(R.id.service_detail_container) != null) {
            ...
            ServiceListFragment fragment = (ServiceListFragment) frgMgr.findFragmentById( R.id.service_list);
